            ...
            for (int y = scanStartY; y < scanFinishY; y++)
            {
                ...
                else
                {
                    ...
                    if (foundObstacle == false)
                    {
                        ...
                        GameObject node = (GameObject)Instantiate(nodePrefab, new Vector3(x + 0.5f + gridBase.transform.position.x, y + 0.5f + gridBase.transform.position.y, -1), Quaternion.Euler(0, 0, 0));
